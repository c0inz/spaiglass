...
# The relay stores only the SHA-256 hash of this token — keep this file
# safe (mode 600). If the token is lost, delete the connector on the
# relay and create a new one.
RELAY_URL=$RELAY_URL
